...
too_slow_text = visual.TextStim(win, text='太慢！', height=2.5, font='Arial Unicode MS', pos=(0, 0), color='red')
...
feedback_text = visual.TextStim(win, text='', color='white', height=2.5, font='Arial Unicode MS')
too_slow_text = visual.TextStim(win, text='太慢！', color='red', height=2.5, font='Arial Unicode MS')
...
def run_formal_trial(trial, flip_side, block):
    ...
    left_option = visual.TextStim(win, text='', height=2.5, font='Arial Unicode MS', pos=(-5, 0), color='white')
    right_option = visual.TextStim(win, text='', height=2.5, font='Arial Unicode MS', pos=(5, 0), color='white')
    if flip_side:
